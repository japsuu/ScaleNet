...
namespace ScaleNet.Common.Transport.Components.Crypto.Certificate.Native
{
    public class CryptContext : DisposeableObject
    {
        ...
        public X509Certificate2 CreateSelfSignedCertificate(SelfSignedCertProperties properties)
        {
            ...
            Win32Native.CryptKeyProviderInformation kpi = new()
            {
            ...
            X509Certificate2 cert = new(certContext); // dups the context (increasing it's refcount)
        ...
        private Win32Native.SystemTime ToSystemTime(DateTime dateTime)
        {
            ...
            Win32Native.SystemTime systemTime = new();
