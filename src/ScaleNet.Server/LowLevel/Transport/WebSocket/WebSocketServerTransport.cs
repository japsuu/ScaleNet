...
namespace ScaleNet.Server.LowLevel.Transport.WebSocket
{
    public class WebSocketServerTransport //: IServerTransport
    {
       ...
       // private bool _configureFor
        ...
        /// </summary>
        public override event Action<ServerStateChangeArgs> OnServerConnectionState;
        /// <summary>
        ...
        public override SessionStateChangeArgs GetConnectionState(int connectionId)
        {
        ...
        public override void HandleServerConnectionState(ServerStateChangeArgs connectionStateArgs)
        {
        ...
        /// </summary>
        /// <param name="connectionStateArgs"></param>
        public override void HandleRemoteConnectionState(SessionStateChangeArgs connectionStateArgs)
        {
